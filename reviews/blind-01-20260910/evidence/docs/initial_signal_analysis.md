...
![Full labelled interval, axes and magnitudes](../data/processed/exercise-02-analysis/overview.png)
...
Values below use original samples in the selected 47.5–67.5 s interval: 1,059 samples per stream. Standard deviations use the population convention. Full-label and quiet-interval statistics are also saved in [analysis.json](../data/processed/exercise-02-analysis/analysis.json).
...
![Candidate events numbered on both signals](../data/processed/exercise-02-analysis/candidate_peaks.png)
