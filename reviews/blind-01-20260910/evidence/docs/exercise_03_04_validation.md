...
![Whole recordings and numbered push-up cycles](../data/processed/exercise-03-04-validation/validation_overview.png)
...
- [Household baseline output](../data/processed/exercise-03-validation/counts.json)
- [Push-up baseline output](../data/processed/exercise-04-validation/counts.json)
- [All 14 cycle boundaries](../data/processed/exercise-04-validation/cycles.csv)
- [Replay, quality, grouping diagnostics and source/code hashes](../data/processed/exercise-03-04-validation/validation.json)

No hardware session was started for the baseline analysis. That analysis changed no production detector code, raw files or source labels. The later provisional reference is stored separately in [reference.json](../data/processed/exercise-04-pauses/reference.json); the original source labels remain unchanged.
