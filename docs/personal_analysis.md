...
**Historical legacy-engine report (10 September 2026).** For the current adaptive
engine and successful fresh blind-02 test, see [Adaptive analysis](adaptive_analysis.md)
and [illustrated results](examples.md). New installations should use the
[user manual](user_manual.md). Local data/model paths below are not bundled.
